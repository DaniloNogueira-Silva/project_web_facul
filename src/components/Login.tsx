                    ...
                    <main className="flex flex-col mt-28 gap-10 w-full max-w-[384px]">
                        <header className="flex flex-col gap-4 w-full max-w-[350px]">
                            ...
                            <p className="font-sans font-normal text-base text-gray-600">
                                Faça login para iniciar uma nova jornada.
                            </p>
                        </header>
                        <form
                ...
                { showModal && (
                    <div className="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50">
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <h2 className="text-lg font-semibold mb-4">Dados do formulário</h2>
                            <p><strong>Email:</strong> { formData.email }</p>
                            <p><strong>Senha:</strong> { formData.password }</p>
                            <button
                                className="bg-purple-500 text-white font-bold py-2 px-4 rounded mt-4"
                                onClick={ () => setShowModal( false ) } // Fecha a modal ao clicar no botão
                            >
                                Fechar
                            </button>
                        </div>
